...
|------|-----------|------------------------|
| **Read** | `GET /libraries/`, `GET /libraries/latest`, `GET /libraries/{slug}`, `GET /libraries/countries/`, `GET /libraries/favourites`, `GET /libraries/mine`, `GET /libraries/mine/reports`, `GET /libraries/mine/photos`, `GET /libraries/moderation/summary`, `GET /libraries/moderation`, `GET /libraries/moderation/pending`, `GET /libraries/moderation/{slug}`, `GET /libraries/moderation/reports`, `GET /libraries/moderation/photos`, `GET /statistics/` | 60 |
| **Bulk export** | `GET /libraries/export/latest.geojson.gz`, `GET /libraries/export/latest.geojson`, `GET /libraries/export/metadata.json`, `GET /libraries/export/{filename}` | Not rate-limited; JWT required |
| **Write** | `POST /auth/devices`, `DELETE /auth/devices/{token}`, `POST /auth/me/contributor-agreement`, `POST /libraries/`, `PATCH /libraries/moderation/{slug}`, `PATCH /libraries/moderation/reports/{report_id}`, `PATCH /libraries/moderation/photos/{photo_id}`, `POST /libraries/{slug}/report`, `POST /libraries/{slug}/photo`, `POST /libraries/{slug}/favourite`, `DELETE /libraries/{slug}/favourite` | 10 |
